                                            ...
                                            <div class="div_design">
                                                <form method="POST" action="/update_product_confirm/{{ $product->id }}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="div_design">
                                                        ...
                                                        <input class="input_color" type="number" name="price" placeholder="Enter Product Price" required value="{{ $product->price }}">
                                                    </div>
                                                    <div class="div_design">
                                                        <label>Discount Price:</label>
                                                        <input class="input_color" type="number" name="discount_price" placeholder="Enter Discount Price" required value="{{ $product->discount_price }}">
                                                    </div>
                                                    <div class="div_design">
