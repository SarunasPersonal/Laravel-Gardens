                      ...
                      <div class="div_design">
                        <form action="{{url('add_product')}}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="div_design">
                            ...
                            <input class="input_color" type="number" name="price" min="0" step="0.01" placeholder="Enter Product Price" required=''>
                          </div>
                          <div class="div_design">
                            <label>Discount Product Price :</label>
                            <input class="input_color" type="number" name="discount_price" min="0" step="0.01" placeholder="Enter Product Price" required=''>
                          </div>
                          <div class="div_design">
                            <label>Product Quantity :</label>
                            <input class="input_color" type="number" name="quantity" placeholder="Enter Product Quantity" required>
                          </div>
                          <div class="div_design">
